...
6. Largest rectangle in Histogram. [Vimp: Hint: Calculate area for every bar considering it to be the shortest length of rectangle, use stack and concept of nearest shortest element on left and right to find area]
